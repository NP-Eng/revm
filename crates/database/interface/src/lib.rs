...
pub trait DatabaseCommit {
    ...
    // NP TODO important: pass only entry_updates: HashMap<Address, Account> and
    // new_leaves: Vec<LeafType> (maybe put together into a new structure
    // DatabaseCommitChanges)
